...
rects2 = ax.bar(index + 1 * bar_width, pd_two_contact_fails, bar_width, alpha=opacity, label='Two Contact')
# rects4 = ax.bar(index + 3 * bar_width, pd_two_contact_gait_fails, bar_width, alpha=opacity, label='Two Contact Gait')
rects3 = ax.bar(index + 2 * bar_width, pd_des_vel_fails, bar_width, alpha=opacity, label='Desired Velocity')
