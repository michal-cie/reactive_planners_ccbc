...
des_contacts = [pd_contact_des_vel, pd_two_contact_des_vel, pd_des_vel_des_vel]
act_contacts = [pd_contact_act_vel, pd_two_contact_act_vel, pd_des_vel_act_vel]
...
ax.set_title('Velocity Error by Policy Type')
